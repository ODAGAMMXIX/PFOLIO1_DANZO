...
- Criar uma pasta na sua area de trabalho (ex: pastateste)
- Abra o terminal do Git. Caso esteja direcionado na pasta **C:** utilizar o comando **cd** (change directory) para navegar entre as pastas
- Ex: cd Users/MyName/Desktop. Isso ira me direcionar a pasta Users, depois para pasta Meu nome e por fim para minha area de trabalho
- Se ao caso errar o caminho, use o comando **cd ..** para retornar uma pasta para tras Ex: se eu estou na pasta Users/MyName/Desktop e der o comando **cd ..** eu irei para pasta Users/MyName 
- Entre na pasta criada na area de trabalho  C:/Users/MyName/Desktop/pastateste.
- Nesta pasta usa o comando git clone https://gitlab.com/web-bot-project/projeto-web-bot.git. Ctrl V normalmente nao funciona entao usa o botao direito do mouse para colar
- Ele irá criar uma pasta com o projeto. Entao precisamos entrar nesta pasta. cd web-bot-project
- Por enquanto ainda estamos na Branch master e tudo que alterarmos seta alterado nela. Por isso sempre é bom estar em outra branch para fazermos nossas alterações nessa branch especifica
- Dar o comando git chekout **<nome da branch>** para trocar de branch
- Depois de fazer alguma alteração e quiser enviar para o git precisamos adionar essas mudanças com o comando **git add .** (ainda dentro da pasta do projeto)
- Depois o com o comando **git commit -m "alteração de bla bla bla"** salvar o arquivo na sua pasta Git/web-bot-project local. É obrigatoria uma mensagem entre as aspas após o –m.
- Agora que o arquivo ja esta salvo na sua maquina basta envia-lo novamente ao gitlab, use o comando **git push** para empurrar o arquivo.
- Pronto, suas alterações ja estão no git na sua branch
